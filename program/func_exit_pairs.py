from constants import CLOSE_AT_ZSCORE_SCORE
...
def manage_trade_exits(client):
    ...
    """
        ...
        Based upon criteria set in contants
    """
    ...
    try:
        ...
        return "complete" #if there isn't a file
    ...
    for position in open_positions_dict:
        ...
        check_m1 = position_market_m1 == order_market_m1 and position_size_m1 == order_size_m1 and position_size_m1 == order_size_m1
        check_m2 = position_market_m2 == order_market_m2 and position_size_m2 == order_size_m2 and position_size_m2 == order_size_m2
        check_live = position_market_m1 in markets_live and position_market_m2 in markets_live

        # if not all match exit with error
        ...
        # Get marekts for reference of tick size
        ...
        if CLOSE_AT_ZSCORE_SCORE:
            
            # Initialize z_scores
            hedge_ratio = position["hedge_ratio"]
            z_score_traded = position["z_score"]
            if len(series_1) > 0 and len(series_1) == len(series_2): # just a check
        ...
        ###
        # !!! ADD ANY OTHER CLOSE LOGIC YOU WANT
        # Trigger is_close
        ###
        ...
        # Keep records of items and save
        else:
            save_output.append(position)

    # Save remaining items
    print(f"{len(save_output)} items ramaining. Saving file...")  
