...
# Format time - returns timestamp in the isoformat needed for the get_ISO_times (DYDX API requires ISO format)
...
# Get ISO Times
"""
    Calculating timestamps to retrieve candles from 100h ago to now
    Then, from 200 h ago to 100 h ago and so on
    Done because API returns max 100 h of candles
"""
def get_ISO_times():
